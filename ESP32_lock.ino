...
//WiFi
const char SSID[] = "ASUS_C05_24G"; //WiFi SSID
const char PASS[] = "attamin0"; //WiFi password
//MQTT
char CLIENTID[] = "ESP32_xx:xx:xx:xx:xx:xx"; //MAC address is set in setup()
//for example, this will be set to "ESP32_84:CC:A8:7A:5F:44"
const char  MQTTADD[] = "192.168.0.3"; //Broker IP address
const short MQTTPORT = 1883; //Broker port
const char  MQTTUSER[] = "siio";//Can be omitted if not needed
const char  MQTTPASS[] = "5110";//Can be omitted if not needed
